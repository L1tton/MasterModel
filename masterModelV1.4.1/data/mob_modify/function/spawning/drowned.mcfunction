...
execute if score random_storage random_storage matches 1..10 run item replace entity @s weapon.mainhand with trident[unbreakable={},custom_data={"weakness_weapon":{}},\
