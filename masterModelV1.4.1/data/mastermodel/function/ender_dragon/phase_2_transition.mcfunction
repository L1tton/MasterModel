...
execute as @a at @s run team join glow_purple @e[distance=..64,type=enderman]
execute as @a at @s run effect give @e[distance=..64,type=enderman,team=glow_purple] glowing 60 0 true 
