...
data merge entity @s {Health:20f,IsBaby:0b,CanBreakDoors:1b,Tags:["strong"],attributes:[{id:"minecraft:attack_damage",base:7.5},{id:"armor",base:3},{id:"minecraft:max_health",base:30},{id:"minecraft:movement_speed",base:0.25},{id:"follow_range",base:48}]}
...
execute if score random_storage random_storage matches 4..10 run item replace entity @s weapon.mainhand with iron_hoe[weapon={disable_blocking_for_seconds:1},custom_data={"mastermodel:mob_weapon":{}},lore=["怪物的"]]
execute if score random_storage random_storage matches 11..13 run item replace entity @s weapon.offhand with gold_ingot

execute if score random_storage random_storage matches 1..10 run tag @s add mm.weapon_mainhand
