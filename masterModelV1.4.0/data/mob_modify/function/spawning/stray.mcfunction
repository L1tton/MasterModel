...
data merge entity @s {Health:20f,Tags:["strong"],attributes:[{id:"minecraft:attack_damage",base:3},{id:armor,base:2},{id:"minecraft:max_health",base:30},{id:"minecraft:movement_speed",base:0.35},{id:"follow_range",base:48}]}

## Giving Skeleton Gear

#weapon give
execute store result score random_storage random_storage run random value 1..50
